...
$meal_section_meta = get_post_meta($meal_section_id, "meal-recipe-metabox", true);
            ...
            <div class="ftco-46">
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    ...
                    <div class="ftco-46-text ftco-46-arrow-up">
                        ...
                        <h3 class="ftco-46-heading">
                            <?php echo esc_html($meal_recipe_three->post_title); ?>
                        </h3>
                        <p class="mb-5">
                            <?php echo esc_html($meal_recipe_three->post_excerpt); ?>
                        </p>
                        <p><a href="<?php echo get_the_permalink($meal_recipe_three); ?>" class="btn-link"> L<?php _e("Learn More", "meal"); ?> <span class="ion-android-arrow-forward"></span></a></p>
                    </div>
                </div>
            </div>
