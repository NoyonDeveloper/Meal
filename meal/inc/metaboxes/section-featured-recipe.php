<?php
function meal_featured_recipe_metabox($metaboxes){
    ...
    $metaboxes[] = array(
        'id' => 'meal-recipe-metabox',
        'title' => __('Recipe', 'meal'),
        'post_type' => 'section',
        'context' => 'normal',
        'priority' => 'default',
        'sections' => array(
            array(
                'id' => 'meal-featured-recipe-section-one',
                'name' => '',
                'icon' => 'fa fa-image',
                'fields' => array(
                    array(
...
add_filter("cs_metabox_options", "meal_featured_recipe_metabox");