<?php
function meal_section_page_picker_metabox($metaboxes){
    ...
    $metaboxes[] = array(
        ...
        'title' => __( 'Section', 'meal' ),
        'post_type' => 'page',
        'context' => 'normal',
        'priority' => 'default',
        'sections' => array(
            array(
                'id' => 'meal-page-section-section-one',
                'name' => '',
                'icon' => 'fa fa-image',
                'fields' => array(
                    array(
...
add_filter("cs_metabox_options", "meal_section_page_picker_metabox");